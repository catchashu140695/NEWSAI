...
def ready_to_upload():
        ...
        with DatabaseConnection(database) as conn:
            if conn is not None:
                ...
                if row:
                    ...
                    attachment_path = "./ready_to_upload/"+ destFileName.replace(".mp4","")+"_final.mp4"
    ...
    shutil.rmtree("./examples/driven_audio/")
    createAudioFoler="examples/driven_audio/"    
...
def add_Image_overlay():
    database = "toshai.db"
    driven_video_folder = "./ready_to_upload/"
        ...
        if conn is not None:
            ...
            try:
                ...
                if row:
                    UrlToImage = row[0]
                    print(UrlToImage)
                    ImageFile= "./ready_to_upload/" + filename +".jpg" 
                    ...
                    if response.status_code == 200:
                        ...
                        video_url = "./ready_to_upload/" + filename + ".mp4"
                        image_url = "./ready_to_upload/" + filename + ".jpg"
                        ...
                        output_url = "./ready_to_upload/" + filename + "_final.mp4"
